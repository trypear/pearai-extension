...
conclusion = f'''Original source: https://github.com/trypear/pearai-submodule/tree/main/docs/docs/languages/{language.lower()}.md

Data for all languages I've looked into so far: https://github.com/trypear/pearai-submodule/tree/main/docs/docs/languages/languages.csv
'''
