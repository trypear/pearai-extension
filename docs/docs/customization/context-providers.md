...
Continue also pre-indexes a number of common sites, listed [here](https://github.com/trypear/pearai-submodule/blob/main/core/indexing/docs/preIndexedDocs.ts). The embeddings for these sites are hosted by us, but downloaded for local use after the first time. All other indexing occurs entirely locally.
...
[Here is a short demo.](https://github.com/trypear/pearai-submodule/pull/859)
...
Not seeing what you want? Create an issue [here](https://github.com/trypear/pearai-submodule/issues/new?assignees=TyDunn&labels=enhancement&projects=&template=feature-request-%F0%9F%92%AA.md&title=) to request a new ContextProvider.
...
Continue will use [esbuild](https://esbuild.github.io/) to bundle your `config.ts` and any dependencies into a single Javascript file. The exact configuration used can be found [here](https://github.com/trypear/pearai-submodule/blob/5c9874400e223bbc9786a8823614a2e501fbdaf7/extensions/vscode/src/ideProtocol.ts#L45-L52).
