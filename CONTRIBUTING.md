...
4. To package the extension, run `npm run package` in the `extensions/vscode` directory. This will generate `extensions/vscode/build/pearai-{version}.vsix`, which you can install by right-clicking and selecting "Install Extension VSIX".
